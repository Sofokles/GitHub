...
public static void main(String[] args) {
	...
	try {
		...
		doc.getDocumentElement().normalize();//gör så att vi kan finna errors..?
		NodeList subList1 = doc.getElementsByTagName("cim:Substation"); //lista med substations, är detta då en lista med objekt..?
